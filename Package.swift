...
let package = Package(
    ...
    products: [
        ...
        .library(name: "MacaroonConcurrency", targets: ["MacaroonConcurrency"]),
        ...
        .library(name: "MacaroonTabBarController", targets: ["MacaroonTabBarController"]),
    ...
    targets: [
        ...
        .target(name: "MacaroonBanner", dependencies: ["MacaroonConcurrency", "MacaroonUIKit"], path: "Sources/MacaroonBanner"),
        ...
        .target(name: "MacaroonConcurrency", dependencies: ["MacaroonUtils"], path: "Sources/MacaroonConcurrency"),
        ...
        .target(name: "MacaroonTabBarController", dependencies: ["MacaroonUIKit"], path: "Sources/MacaroonTabBarController"),
