...
extension DeeplinkRouter {
    @discardableResult
    public func openScreen<T: UIViewController>(_ url: URL, from source: UIViewController, by transition: RouteTransition.Open = .presentation(), animated: Bool = true, onCompleted handler: TransitionCompletionHandler? = nil) -> T? {
